...
public class Client extends Thread { 
    ...
    private static boolean checkSendingStatus = false;
    private static boolean checkReceivingStatus = false;
     ...
     */
     public void sendTransactions()
     {
         ...
         {  
            while( objNetwork.getInBufferStatus().equals("full") && (!objNetwork.getServerConnectionStatus().equals("disconnected"))) {    /* Alternatively, busy-wait until the network input buffer is available */
            	Thread.yield();
            }
     ...
     */
     public void receiveTransactions(Transactions transact)
     {
         ...
         while (i < getNumberOfTransactions())
         {     
        	while( objNetwork.getOutBufferStatus().equals("empty") && (!objNetwork.getServerConnectionStatus().equals("disconnected"))) {		/* Alternatively, busy-wait until the network output buffer is available */
        		Thread.yield();
        	}
	...
	/* Implement the code for the run method */
    	if(clientOperation.equals("sending")) {
    		...
    		checkReceivingStatus = true;
    	}
    	if(checkSendingStatus && checkReceivingStatus) {
